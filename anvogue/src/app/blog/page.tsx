                ...
                <div className="container">
                    <div className="flex justify-between max-md:flex-col gap-y-12">
                        ...
                        <div className="left xl:w-3/4 md:w-2/3 pr-2">
                            {posts.length === 0 ? (
                                <div className="text-secondary py-10 text-center">No posts published yet. Check back soon!</div>
                            ) : (
                            ...
                            {pageCount > 1 && (
                                <div className="flex items-center justify-center gap-2 md:mt-10 mt-6">
                                    {Array.from({ length: pageCount }, (_, i) => i + 1).map((p) => (
                                        <Link
                                            key={p}
                                            href={`/blog?${new URLSearchParams({ ...(category ? { category } : {}), page: String(p) })}`}
                        ...
                        <div className="right xl:w-1/4 md:w-1/3 xl:pl-[52px] md:pl-8">
                            <form className='form-search relative w-full h-12' action="/blog" method="get">
                            ...
                            {categories.length > 0 && (
                                <div className="filter-category md:mt-10 mt-6 pb-8 border-b border-line">
                                    ...
                                    <div className="list-cate pt-1">
                                        ...
                                        {category && (
                                            <Link href="/blog" className="mt-3 block text-sm text-secondary hover:text-black underline">
                                                Clear filter
                                            </Link>
                                        )}
                                    </div>
